            ...
            <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                ...
                <div className="lg:order-first lg:row-span-2">
                    ...
                    <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
                        ...
                        <p>
                            In the summer and autumn 2023 I pursued and got certified as an AWS Developer.
...
function AwsCertifiedDeveloper() {
    return (
        <a href="https://www.credly.com/badges/08b4a129-3da6-4a51-8a4a-ae9356d777db/public_url" target="_blank"
           rel="noopener noreferrer">
            <Image src={awsCertifiedDeveloper} alt="AWS Certified Developer Associate" className="mt-8" width="600"
                   height="600"/>
        </a>
    )
}
...
function DataCampDataScientist() {
    return (
        <a href="https://www.datacamp.com/portfolio/marcusholmgren" target="_blank" rel="noopener noreferrer">
            <Image src={dataCampDataScientist} alt="DataCamp Professional Data Scientist Certificate" className="mt-8"
                   width="186" height="215"/>
        </a>
    )
}
