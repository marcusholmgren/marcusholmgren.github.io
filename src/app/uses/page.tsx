...
function Tool({ title, href, children }: PropsWithChildren<{ title: string, href?: string }>) {
  return (
    <Card as="li">
        ...
        <div className="space-y-20">
          ...
          <ToolsSection title="Design">
            <Tool title="Tailwind UI">
              With the exception of a few things I’ve built myself, I’ve used Tailwind UI for every design I’ve done in the last year.
              It’s a great way to get started quickly and it’s a great way to get started quickly.
              And Tailwind CSS is a great way to to style things quickly.
            </Tool>
          </ToolsSection>
          <ToolsSection title="Educational platforms">
            ...
            <Tool title="DataCamp">
              I really like the gamified approach to practice and learn data science.
              The hosted notebooks are great when you don’t want to install or setup anything on your local machine.
            </Tool>
            <Tool title="Egghead">
